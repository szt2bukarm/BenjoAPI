...
exports.parseSongSearchResult = (context) => {
    ...
    let sectionList = utils.fv(context, 'musicResponsiveListItemRenderer', true);

    if (!Array.isArray(sectionList)) {
        sectionList = [sectionList];
    }

    for (const sectionContext of sectionList) {
        const flexColumn = utils.fv(sectionContext, 'musicResponsiveListItemFlexColumnRenderer', true);
        result.content.push({
            type: 'song',
            ...
            artist: (function() {
                let a = [];
                let c = utils.fv(flexColumn[1], 'runs');
                if (Array.isArray(c)) {
            ...
            album: (function() {
                let c = _.first(utils.fv(flexColumn[1], 'runs', true));
